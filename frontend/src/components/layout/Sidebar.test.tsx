...
const regularUser: AuthUser = { id: "u1", username: "ada", full_name: "Ada Lovelace", role: "user" };
const adminUser: AuthUser = { id: "u2", username: "grace", full_name: "Grace Hopper", role: "admin" };
