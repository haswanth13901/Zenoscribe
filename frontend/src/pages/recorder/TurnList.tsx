...
import type { PartialTurn, Turn } from "../../features/recorder/types";
...
function TurnRow({ speaker, text, start, isPartial }: { speaker: string; text: string; start?: number | null; isPartial?: boolean }): ReactElement {
