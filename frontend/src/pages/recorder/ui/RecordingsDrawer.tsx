  ...
  return (
    <div className={styles.card}>
      <div className={styles.meta}>
        {new Date(recording.started_at).toLocaleString()} &middot; {fmtDur(recording.duration)}{" "}
        &middot; {recording.turn_count} turns
      </div>
...
export function RecordingsDrawer({ open, onClose }: RecordingsDrawerProps): ReactElement | null {
  ...
  const {
    ...
    { user_id: user.id, date_from: dateFrom || undefined, date_to: dateTo || undefined },
    { skip: !open },
  );
