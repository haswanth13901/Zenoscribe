...
describe("TurnList", () => {
  ...
  it("renders final turns with speaker label, text, and timestamp", () => {
    render(<TurnList turns={[{ speaker: "user-1", text: "hello there", start: 1.5 }]} partial={null} />);
  ...
  it("renders a trailing partial turn distinctly from final turns", () => {
    render(<TurnList turns={[{ speaker: "user-1", text: "final one", start: 0 }]} partial={{ speaker: "user-2", text: "still talking" }} />);
