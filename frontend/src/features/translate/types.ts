...
export type ServerMessage =
  | { type: "ready" }
  | { type: "captions"; source: string; translation: string; speaker: string | null; language: string | null }
...
export type TranslateEvent =
  ...
  | { type: "captions"; source: string; translation: string; speaker: string | null; language: string | null; ts: number }
